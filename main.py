...
def train():
    ...
    valid_data = LWFDataset(data_dir=opt.lwf_data_dir, split='pairsDevTrain', transform=validTransform)
    ...
    for epoch in range(opt.max_epoch):
        ...
        for i, data in tqdm((enumerate(train_loader))):
            ...
            loss = criterion(outputs0, outputs1, labels)
            loss.backward()
            optimizer.step()
